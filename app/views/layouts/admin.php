    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="<?= ADMIN ?>/order"><i class="fa fa-shopping-cart"></i> <span>Order</span></a></li>
                <li class="treeview">
                ...
                <li><a href="<?= ADMIN ?>/cache"><i class="fa fa-database"></i> <span>Caching</span></a></li>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?= ADMIN ?>/user/add">Add users</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?= ADMIN ?>/currency">List currency</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="<?= ADMIN ?>/filter/attribute">Filter</a></li>
                    </ul>
                </li>
            </ul>
        </section>
