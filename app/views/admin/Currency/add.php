            ...
            <div class="box">
                <form action="<?=ADMIN;?>/currency/add" method="post" data-toggle="validator">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" name="title" class="form-control" id="title" placeholder="Name currency" required>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <label for="code">Code currency</label>
                        <input type="text" name="code" class="form-control" id="code" placeholder="Code currency" required>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    </div>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" name="value" class="form-control" id="value" placeholder="Value" required data-error="Digits and decimal point allowed" pattern="^[0-9.]{1,}$">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
